...
# plot
outfile_full = outdir + "/" + "gmm_star_pos.png"
print("outfile = ", outfile_full)
...
if (1 == flag_cat):
    ...
    data_gmm_spike_df = data_gmm_df[data_gmm_df["nstar_cat8"]==0]
    plt.scatter(data_gmm_spike_df['pc01'],
                data_gmm_spike_df['pc02'],
                s=1, c="b")
    data_gmm_star_df = data_gmm_df[data_gmm_df["nstar_cat8"]>0]
    plt.scatter(data_gmm_star_df['pc01'],
                data_gmm_star_df['pc02'],
                s=1, c="r")
    ...
    # plot
    outfile_full = outdir + "/" + "gmm_cat.png"
    print("outfile = ", outfile_full)
...
if (1 == flag_cat):
    ...
    # data_df["star_pos"] > 1 : star
    # data_df["star_pos"] <= 1 : spike

    data_star0_gmm0_df = data_gmm_df[(data_gmm_df["star_pos"]<=1) &
                                     (data_gmm_df["cluster_gmm"]==0)]
    data_star0_gmm1_df = data_gmm_df[(data_gmm_df["star_pos"]<=1) &
                                     (data_gmm_df["cluster_gmm"]==1) ]
    data_star1_gmm0_df = data_gmm_df[(data_gmm_df["star_pos"]>1) &
                                     (data_gmm_df["cluster_gmm"]==0) ]
    data_star1_gmm1_df = data_gmm_df[(data_gmm_df["star_pos"]>1) &
                                     (data_gmm_df["cluster_gmm"]==1) ]
    data_star0_df = data_gmm_df[(data_gmm_df["star_pos"]<=1)]
    data_star1_df = data_gmm_df[(data_gmm_df["star_pos"]>1)]
    nevt_true_negative = len(data_star0_gmm0_df)
    nevt_false_positive = len(data_star0_gmm1_df)
    nevt_false_negative = len(data_star1_gmm0_df)
    nevt_true_positive = len(data_star1_gmm1_df)
