...
# usage:
#  python3 plot_pca_cat_before_lrm.py 1 0 0 def def def def
...
if (7 == nargs):
    ...
    print('usage: python3 plot_pca_cat_before_lrm.py flag_cat pca_feature use_prefit ' +
