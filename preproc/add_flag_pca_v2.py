...
#   % python $akari_tool/preproc/add_flag_pca_v2.py
#
...
outdir = indir
outfile_full = outdir + "/" + "pca_v2.png"
...
outdir = indir
outfile_full = outdir + "/" + "pca_contrib_v2.png"
print("outfile = ", outfile_full)
plt.savefig(outfile_full,
            bbox_inches='tight',
            pad_inches=0.1)
...
outfile_full = outdir + "/" + "pca_comp_sort_by_pc0_v2.txt"
np.savetxt(outfile_full, pc01_name_sort_by_pc0_2darr, 
           fmt=['%.5e', '%.5e', '%s'])
outfile_full = outdir + "/" + "pca_comp_sort_by_pc1_v2.txt"
np.savetxt(outfile_full, pc01_name_sort_by_pc1_2darr,
           fmt=['%.5e', '%.5e', '%s'])

outfile_full = outdir + "/" + "pca_comp_v2.png"
print("outfile = ", outfile_full)
plt.savefig(outfile_full,
            bbox_inches='tight',
            pad_inches=0.1)
...
outdir = indir
outcsv = outdir + "/" + "akari_stat_fit_star_cat_pca_v2.csv"
