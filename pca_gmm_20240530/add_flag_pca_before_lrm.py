#
# add_flag_pca_before_lrm.py
#
# add pca components (before left-right match)
#
...
# python3 add_flag_pca_before_lrm.py 1 0 0 def def def def
...
if (7 == nargs):
    ...
    print('usage: python3 add_flag_pca_before_lrm.py ' +
...
# pca and gmm calc before selection of left-right match: "star_pos" > 1
