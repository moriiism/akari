...
#   % python $akari_tool/plot_gmm/gmm_2d_2cl.py
...
if (6 == nargs):
    ...
    print('usage: python gmm_2d_2cl.py 1/0 1/0 ' +
...
if (0 == flag_cat):
    ...
    incsv = indir + "/" + "akari_stat_fit_star_pca_cat.csv"
else:
...
gmm = None
if (use_prefit == 1):
    prefit_pkl = os.environ["GMM_MODEL"]
...
outdir = indir
outfile_full = outdir + "/" + "gmm_2d_2cl.png"
...
if (1 == flag_cat):
    ...
    outdir = indir
    outcsv = outdir + "/" + "akari_stat_fit_star_pca_gmm_2d_2cl.csv"
    print(f"outcsv = {outcsv}")
    data_gmm_df.to_csv(outcsv, index=False)

    outdir = indir
    outcsv = (outdir + "/"
              + "akari_stat_fit_star_pca_gmm_2d_2cl_simple.csv")
    print(f"outcsv = {outcsv}")
