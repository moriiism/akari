...
if (use_prefit == 0):
    ...
    out_pkl = indir + "/" + "pca_margin.pkl"
    pk.dump(pca, open(out_pkl,"wb"))
elif (use_prefit == 1):
    prefit_pkl = os.environ["PCA_MARGIN_MODEL"]
...
outdir = indir
outfile_full = outdir + "/" + "pca_margin.png"
...
outdir = indir
outfile_full = outdir + "/" + "pca_margin_contrib.png"
print("outfile = ", outfile_full)
plt.savefig(outfile_full,
            bbox_inches='tight',
            pad_inches=0.1)
...
outfile_full = outdir + "/" + "pca_margin_comp_sort_by_pc0.txt"
np.savetxt(outfile_full, pc01_name_sort_by_pc0_2darr, 
           fmt=['%.5e', '%.5e', '%s'])
outfile_full = outdir + "/" + "pca_margin_comp_sort_by_pc1.txt"
np.savetxt(outfile_full, pc01_name_sort_by_pc1_2darr,
           fmt=['%.5e', '%.5e', '%s'])

outfile_full = outdir + "/" + "pca_margin_comp.png"
print("outfile = ", outfile_full)
plt.savefig(outfile_full,
            bbox_inches='tight',
            pad_inches=0.1)
...
outdir = indir
outcsv = outdir + "/" + "akari_stat_fit_star_cat_pca_margin.csv"
