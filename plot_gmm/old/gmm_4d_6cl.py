...
print(data_gmm_df[['pc01', 'pc02', "pc03", "pc04", "cluster_gmm"]])
...
plt.scatter(data_gmm_cl4_df['pc01'],
            ...
            s=1, c="yellow")
data_gmm_cl5_df = data_gmm_df[data_gmm_df["cluster_gmm"]==5]
plt.scatter(data_gmm_cl5_df['pc01'],
            data_gmm_cl5_df['pc02'],
            s=1, c="magenta")
...
outdir = indir
outfile_full = outdir + "/" + "gmm_4d_6cl.png"
